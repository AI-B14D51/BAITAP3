...
void KhoiTao(string filein, string filein2, vector<vector<int>> &Matrix) {
...
void Result_Astar(int s, int t, vector<vector<int>> Matrix) {
    ...
    fout << "Bo nho su dung: " << "VM: " << vm << " KB" << "; RSS: " << rss << "KB" << endl;
    fout.close();
}
...
double Astar::get_solution(bool is_ds)
{
    ...
    KhoiTao(Constants::FILEIN, Constants::FILEIN2, Matrix);
    ...
    fout << "Thoi gian thuc hien A*: " << time_taken * 1000 << " ms";
    fout.close();
	return 0.0;
}
