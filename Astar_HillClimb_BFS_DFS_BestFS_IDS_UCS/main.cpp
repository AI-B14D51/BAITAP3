...
void print_help() {
	...
	cout << "-f <data filename>" << endl
	        << "f1 <data thamsodinh> # default: 0,0,0,.." << endl
		...
		<< "-a <algorithm, 0: DFS, 1: BFS, 2: BestFS, 3: ids, 4: ucs, 5: Astar, 6: HillClimbing>  # default: 2, please use SSA source code for testing IM algorithm" << endl
